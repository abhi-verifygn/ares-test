...
<?php
    ...
    *******************************************************************************/
    ...
    define( "RESTART_VOIP_SCRIPT","/usr/bin/do_voip_restart.sh" );
    ...
    **
    */
    function voip_update( $connection, $writeTables, $readTables, $requestData, &$errors )
    {
        $success = false;

        #error_log("starting voip_update\n", 3, "voip_log.txt");
        ...
        else
        {
            ...
            $successfulUpdates = 0;
			$writePtr = $writeTables["VoIPSettings"];
			$paramPtr = $readTables["VoIPSettings"];
            ...
            @exec( RESTART_VOIP_SCRIPT . "", $output, $returnVal );
    ...
    */
    ...
    #error_log( "Starting do.voip.php\n", 3, "voip_log.txt" );
...
//        error_log( $_POST, 3, "voip_log.txt");

        if ( !VenusPerformFormMultiTableUpdate( $_POST,
                $writeTables, $readTables, "voip", "voip_update", $warnings ) )
        {
