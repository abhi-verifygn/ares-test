...
<body>
  <table class="MMM">
    <tr>
      <td>
        <!-- BEGIN NET_FORM -->
        <form action="do.msc.php" method="post" name="FormMiscSettings" id=
        "FormMiscSettings" accept-charset="ISO-8859-1">
          ...
          <table class="F1" align="center" cellspacing="0">
            <tr>
              <td id="{ERROR_ID}_TD">
                  <td><font face="arial" color="#FF0000"><b>Attention!
              Changing network settings could render this device
              inaccessible from this computer.</b></font><br>
              {SESSION_ERROR_MESSAGE}</td>
