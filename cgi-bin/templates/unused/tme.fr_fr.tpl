...
<body>
  <table class="MMM">
    <tr>
      <td>
        <!-- BEGIN TME_FORM -->
        <form action="do.tme.php" method="post" name="FormWorkingHours" id=
        "FormWorkingHours" accept-charset="ISO-8859-1">
              ...
              <td class="M2">
                ...
                cellpadding="4">
                  ...
                  <tr>
                    ...
                    <td class="bb1">&nbsp;{OPEN_TIME_VALUE}</td>
