...
<body>
  <table class="MMM">
    <tr>
      <td>
        <!-- BEGIN VLM_FORM -->
        <form action="do.vlm.php" method="post" name="FormDriveVolume" id=
        "FormDriveVolume" accept-charset="ISO-8859-1">
          <blockquote>{TITLE}
          </blockquote>
                ...
                cellpadding="4">
                  ...
                  <tr>
                    ...
                    <td width="30" class="m4">
                      ...
                      <input type="text"
                        {TEXT_DISABLED}
                        name="params[{TEXT_PARAM_NAME}]" size="4" maxlength="4"
                    ...
                    <td width="30" class="m4">
                      ...
                      <input type="text"
                        {TEXT_DISABLED}
                        name="params[{TEXT_PARAM_NAME_L2}]" size="4" maxlength="4"
                  ...
                  <!-- BEGIN USER_READONLY -->
                  <tr>
                    <td class="rb" width="390" height="25">{USER_DISPLAY_NAME}</td>

                    <td class="bb">{USER_DISPLAY_VALUE}&nbsp;</td>

                    <td class="lb" width="20">{USER_ENTRY_NO}.</td>

                    <td width="30" class="m4"></td>

                    <td class="bb">{USER_DISPLAY_VALUE_L2}&nbsp;</td>

                    <td class="lb" width="20">{USER_ENTRY_NO_L2}.</td>
