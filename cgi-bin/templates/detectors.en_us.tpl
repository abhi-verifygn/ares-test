...
<body>
  <table class="MMM">
    <tr>
      <td>
        <!-- BEGIN DET_FORM -->
        <form action="do.detectors.php" method="post" name="FormDetectors" id=
        "FormDetectors" accept-charset="ISO-8859-1">
          <blockquote>{TITLE}
          </blockquote>
            ...
            <tr>
              <td class="M2">
                ...
                cellpadding="4">
                  <!-- BEGIN FORM_ENTRY -->
                  <tr>
                    <td class="rb" width="300" height="25">{PARAM_DISPLAY_NAME}</td>

                    <td class="bb">{PARAM_DISPLAY_VALUE}&nbsp;</td>

                    <td class="lb" width="20">{ENTRY_NO}.</td>

                    <td width="200" class="m4">
                      <!-- BEGIN FORM_TEXT -->
                      <input type="text"
