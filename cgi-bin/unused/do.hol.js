/******************************************************************************
**
**  COMPONENT:          do.hol.js - support functions for Venus
**
**  REVISION:           $Revision:  $
**  LAST MODIFIED BY:   $Author:  $
**  DATE:               $Date:  $
**
**  AJAX support for holiday opening dates and times data for the
**  holiday (hol) page
**
*******************************************************************************
**
...
function BuildQuery()
{
    ...
    {
        aResult = new Array( 1 );
        aResult[ 0 ] = new Object();
        aResult[ 0 ].name = "Error";
        aResult[ 0 ].value = "No valid data retrieved";
    }
